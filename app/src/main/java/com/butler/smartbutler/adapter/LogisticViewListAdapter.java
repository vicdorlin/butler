...
public class LogisticViewListAdapter extends BaseAdapter {

    private Context mContext;
    private List<LogisticData> mList;
    //布局加载器
    private LayoutInflater inflater;
    private LogisticData data;

    public LogisticViewListAdapter(Context mContext, List<LogisticData> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.layout_logistic_item, null);
