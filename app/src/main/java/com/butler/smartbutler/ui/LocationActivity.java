...
public class LocationActivity extends BaseActivity {
    ...
    public class MyLocationListener extends BDAbstractLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            //通过回调的BDLocation中的getFloor()是否为空，判断当前是否已经处于室内定位区域
            if (location.getFloor() != null) {
                ...
                ToastUtil.showShortToastCenter("buildingID:" + buildingID + "buildingName:" + buildingName + "floor:" + floor);
            }
            ...
            L.i("\nlatitude:" + latitude + "\nlongitude:" +
                    ...
                    "\nlocationDescribe:" + location.getLocationDescribe() + sb.toString());
            //Receive Location
